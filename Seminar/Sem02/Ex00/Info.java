...
Если в процессе написания программы, стал выбор межку использованием 
интерфейса или абстрактного класса, то, в случае, когда есть необходимость
связать классы между собой, либо между ними уже есть какая-то связь, 
например, логическая, то рекомендуется использовать абстрактный класс.
 ...
 * "Info" уже не может наследовать ещё какой-нибудь класс, например, "TextInfo",
 * будет выводится ошибка.
 */
